...
public class LogoutTest {
	...
	public void logoutTest() throws Exception {
		...
		driver.findElement(By.xpath("//*[@id=\"T:header\"]/div[2]/div[2]/div[6]/div/a")).click();
		Thread.sleep(3000);
		
		driver.findElement(By.xpath("//*[@id=\"T:header\"]/div[2]/div[2]/div[6]/div/div/div[2]/input[2]")).click();
		Thread.sleep(2000);
